const CACHE='ygdria-backstage-2.1.0';
const FILES=['./','./index.html','./styles.css','./app.js','./studio.js','./storage.js','./validation.js','./dialogs.js','./realm-slots.js','../data/content.json'];
