...
check('vitrine humana pré-carrega poses e trata M como conjuração local',()=>{
  for(const needle of ['function preloadSpriteSource(','function preloadLabAction(','readySpriteAssets','pendingSpriteAssets','await preloadLabAction(entry,action)','Conjuração','lab-aura','configureLabAura','conjurationAuraVfx','specialConjurationVfx','conjurationVfxFor','v13-conjuration/aura-runes/processed/sheet-transparent.png','v14-conjuration/special/kalander','v14-conjuration/special/bernyce','v14-conjuration/special/jules','v14-conjuration/special/julius','julius/cast-r5/processed/sheet-transparent.png','webkitMaskImage','dataset.masked','action===\'cast\'&&chapterMode']) assert.ok(animationShowcase.includes(needle),`${needle} ausente da vitrine`);
