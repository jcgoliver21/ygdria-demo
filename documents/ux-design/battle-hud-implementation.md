...
O HUD ilustrado é oferecido em Opções → Arena como **Layout 2.0**. O layout simplificado permanece padrão; a escolha é persistida em `12r_viz` e pode ser trocada durante a batalha sem recriar o tabuleiro, alterar HP ou reiniciar o turno.
